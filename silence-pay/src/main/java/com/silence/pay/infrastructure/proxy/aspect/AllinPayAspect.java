...
@Order(1)
@Component
public class AllinPayAspect extends BaseMethodAspect {

    /**
     * 指定切点（处理打上 InvokeRecordAnno 的方法）
     */
    @Override
    @Pointcut("@annotation(com.silence.pay.infrastructure.proxy.anno.AllinPayAnno)")
    protected void pointcut() { }

    @Override
    protected Class<? extends MethodAdviceHandler<?>> getAdviceHandlerType() {
        return AllinPayHandler.class;
    }
}
